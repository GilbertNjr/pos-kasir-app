        ...
        >
          ...
          <div>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.6rem', marginBottom: '0.25rem' }}>
              ...
              <span style={{ padding: '0.15rem 0.55rem', borderRadius: '12px', background: 'rgba(59, 130, 246, 0.25)', color: '#60a5fa', fontSize: '0.75rem', fontWeight: 900, border: '1px solid rgba(96, 165, 250, 0.35)' }}>v1.7.6</span>
            </div>
