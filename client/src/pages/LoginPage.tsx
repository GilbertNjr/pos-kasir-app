...
export const LoginPage: React.FC<LoginPageProps> = ({ onLoginSuccess }) => {
  ...
  return (
    ...
    >
      ...
      {/* EMERGENCY PASSWORD RECOVERY MODAL (CARA KEDUA APABILA LUPA KATA SANDI) */}
      {showRecoverModal && (
        <div style={{ position: 'fixed', inset: 0, background: 'rgba(15, 23, 42, 0.65)', backdropFilter: 'blur(4px)', zIndex: 9999, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '1rem' }}>
          <div style={{ background: '#ffffff', borderRadius: '24px', padding: '1.75rem', maxWidth: '440px', width: '100%', boxShadow: '0 25px 50px -12px rgba(0, 0, 0, 0.25)', border: '1px solid #e2e8f0' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.6rem', marginBottom: '0.35rem' }}>
              ...
              <div>
                <h3 style={{ fontSize: '1.15rem', fontWeight: 900, color: '#0f172a', margin: 0 }}>Pemulihan Akun Owner</h3>
                <div style={{ fontSize: '0.75rem', color: '#64748b' }}>Metode Kedua Jika Lupa Password</div>
              </div>
            </div>

            <p style={{ fontSize: '0.8rem', color: '#475569', marginBottom: '1.25rem', lineHeight: 1.4 }}>
              Masukkan Username, <strong>PIN Pemulihan Darurat (6-Digit)</strong> Anda, serta Password Baru untuk memulihkan akun secara instant.
            </p>
            ...
            <form onSubmit={handleRecoverSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
              <div>
