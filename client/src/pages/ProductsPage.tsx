...
export const ProductsPage: React.FC<ProductsPageProps> = ({ currentUser, onTriggerToast }) => {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '1.75rem', paddingBottom: '3rem' }}>
      {/* 1. TOP METRIC CARDS BAR (5 DYNAMIC REAL-TIME GRID COLUMNS: 2 CARDS PER ROW ON MOBILE, 5 ON DESKTOP) */}
      <div className="product-kpi-grid">
        {/* CARD 1: TOTAL PRODUK */}
        <div className="product-kpi-card kpi-card-total">
          <div className="product-kpi-icon icon-blue">
            <Package size={20} />
          </div>
          <div className="product-kpi-content">
            <div className="product-kpi-label">Total Produk</div>
            <div className="product-kpi-value">
              {totalProductCount} <span className="product-kpi-unit unit-slate">Item</span>
            </div>
          </div>
        </div>

        {/* CARD 2: PRODUK AKTIF */}
        <div className="product-kpi-card kpi-card-active">
          <div className="product-kpi-icon icon-emerald">
            <CheckCircle2 size={20} />
          </div>
          <div className="product-kpi-content">
            <div className="product-kpi-label">Produk Aktif</div>
            <div className="product-kpi-value">
              {activeProductCount} <span className="product-kpi-unit unit-emerald">Aktif</span>
            </div>
          </div>
        </div>

        {/* CARD 3: PRODUK NON-AKTIF */}
        <div className="product-kpi-card kpi-card-inactive">
          <div className="product-kpi-icon icon-rose">
            <XCircle size={20} />
          </div>
          <div className="product-kpi-content">
            <div className="product-kpi-label">Produk Non-Aktif</div>
            <div className="product-kpi-value">
              {inactiveProductCount} <span className="product-kpi-unit unit-rose">Item</span>
            </div>
          </div>
        </div>

        {/* CARD 4: STOK MENIPIS */}
        <div className="product-kpi-card kpi-card-warning">
          <div className="product-kpi-icon icon-amber">
            <AlertTriangle size={20} />
          </div>
          <div className="product-kpi-content">
            <div className="product-kpi-label">Stok Menipis</div>
            <div className="product-kpi-value">
              {lowStockCount} <span className="product-kpi-unit unit-amber">Item</span>
            </div>
          </div>
        </div>

        {/* CARD 5: STOK HABIS (Full width on mobile or 5th col on desktop) */}
        <div className="product-kpi-card kpi-card-danger product-kpi-card-span-mobile">
          <div className="product-kpi-icon icon-crimson">
            <PackageX size={20} />
          </div>
          <div className="product-kpi-content">
            <div className="product-kpi-label">Stok Habis</div>
            <div className="product-kpi-value">
              {outOfStockCount} <span className="product-kpi-unit unit-crimson">Habis</span>
            </div>
          </div>
        </div>
      </div>
